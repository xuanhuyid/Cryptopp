...
#include "include/cryptopp/filters.h" //string input, output
...
#include "include/cryptopp/files.h" // File input, output
using CryptoPP::FileSink;
using CryptoPP::FileSource;

#include "include/cryptopp/osrng.h" // random generator
using CryptoPP::AutoSeededRandomPool;

#include "include/cryptopp/SecBlock.h" // byte in CryptoPP
